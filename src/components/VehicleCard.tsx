...
function VehicleCard({
  ...
  return (
    <motion.div
      ...
      className="relative bg-white border borde-zinc-200 rounded-3xl overflow-hidden flex flex-col group cursor-default"
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3">
            ...
            <p className="text-zinc-900 text-sm flex items-center font-black"> 
                <IndianRupee size={12}/>{vehicle.pricePerKM}
            </p>
          </div>
