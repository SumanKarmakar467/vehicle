    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        <div className="relative text-center">
          ...
          <h1 className="text-2xl font-bold mt-1">Upload Document</h1>
        ...
        <div className="mt-6 flex items-start gap-3 text-x5 text-gray-500">
          <FileCheck/>
          <p size={16} className="mt-0.5">Documents are securely stored and manually verified by our team.</p>
        </div>
